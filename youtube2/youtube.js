...
(function(plugin) {
        ...
        settings.createBool("showVideoRecommendations", "Show User Video Recommendations", false, function(v) {
    ...
    plugin.addURI(plugin.getDescriptor().id + ":user:(.*)", function(page, id) {
        page.loading = true;
        ...
        if (service.showFavorites && favoritesPlaylistId) {
                ...
                if (favorites.length > 0) {
                    ...
                    if (user == "default") page.appendPassiveItem("list", favorites, {
                        title: "Favorites"
                    });
                    lists_tmp.favorites = {
                        array: favorites,
        ...
        if (id == "default") {
            if (service.showWatchLater) {
                ...
                if (watchLater.length > 0) {
                    ...
                    if (user == "default") page.appendPassiveItem("list", watchLater, {
                        title: "Watch Later"
                    });
            ...
            if (service.showWatchHistory) {
                ...
                if (watchHistory.length > 0) {
                    ...
                    if (user == "default") page.appendPassiveItem("list", watchHistory, {
                        title: "Watch History"
                    });
            ...
            if (service.showSubscriptions) {
                ...
                if (subscriptions.length > 0) {
                    ...
                    if (user == "default") page.appendPassiveItem("list", subscriptions, {
                        title: "Subscriptions"
                    });
        ...
        if (id == "default") {
            if (service.showVideoRecommendations) {
                ...
                if (videoRecommendations.length > 0) {
                    ...
                    if (user == "default") page.appendPassiveItem("list", videoRecommendations, {
    ...
    function setVideoItemOptions(item, page) {
        if (item.channelId)
            item.addOptURL("More from this channel", plugin.getDescriptor().id + ':user:' + item.channelId);
    ...
    plugin.addURI(plugin.getDescriptor().id + ":start", function(page) {
        ...
        items.push(page.appendItem(plugin.getDescriptor().id + ':scraper:/channels:' + escape(showtime.JSONEncode({
            "part": "id,snippet",
            "categoryId": 0
        ...
        items.push(page.appendItem(plugin.getDescriptor().id + ':edu:' + escape('Youtube EDU'), 'directory', {
            title: 'Youtube EDU',
            icon: plugin.path + "views/img/logos/edu.png"
        }));
        items.push(page.appendItem(plugin.getDescriptor().id + ':mixfeeds:' + 'live_feeds:' + escape('Youtube Live'), 'directory', {
            title: 'Youtube Live',
            icon: plugin.path + "views/img/logos/live.png"
        }));
        items.push(page.appendItem(plugin.getDescriptor().id + ':mixfeeds:' + 'movie_feeds:' + escape('Youtube Movies'), 'directory', {
            title: 'Youtube Movies',
            icon: plugin.path + "views/img/logos/movies.png"
        }));
        items.push(page.appendItem(plugin.getDescriptor().id + ':mixfeeds:' + 'show_feeds:' + escape('Youtube Shows'), 'directory', {
            title: 'Youtube Shows',
            icon: plugin.path + "views/img/logos/shows.png"
        }));
        items.push(page.appendItem(plugin.getDescriptor().id + ':disco:null:' + escape('Youtube Disco'), 'directory', {
            title: 'Youtube Disco',
            icon: plugin.path + "views/img/logos/disco.png"
        }));
...
//showtime.print(url + ' ' + showtime.JSONEncode(args));
        ...
        plugin.addURI(plugin.getDescriptor().id + ":v3:request:(.*):(.*)", function(page, args, title) {
                ...
                scraper(page, args.request.type, args);
                ...
                if (entry.kind == "youtube#activity") {
                    ...
                    if (type == "upload") {
                        ...
                        if (resourceId == "youtube#video") {
                            ...
                            var item = page.appendItem(plugin.getDescriptor().id + ":v3:request:" + escape(showtime.JSONEncode({
                                "part": "id,snippet",
                                "playlistId": playlistId,
                                "request": {
                                    "type": "playlistItems",
